...
import type { ExternalBlob as _ExternalBlob, Order as _Order, PublicProfile as _PublicProfile, UserProfile as _UserProfile, UserRole as _UserRole, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async placeOrder(arg0: Array<OrderItemInput>): Promise<{
        __kind__: "ok";
        ok: Order;
    } | {
        __kind__: "err";
    ...
    async updateProfileAdmin(arg0: boolean): Promise<{
        __kind__: "ok";
        ok: PublicProfile;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.updateProfileAdmin(arg0);
    ...
    async updateProfileAvatar(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProfileAvatar(await to_candid_ExternalBlob_n21(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PublicProfile_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PublicProfile): Promise<PublicProfile> {
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        avatarBlob: record_opt_to_undefined(await from_candid_opt_n16(_uploadFile, _downloadFile, value.avatarBlob)),
        userId: value.userId,
...
async function from_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "ok" in value ? {
        __kind__: "ok",
        ok: await from_candid_PublicProfile_n20(_uploadFile, _downloadFile, value.ok)
    } : "err" in value ? {
        __kind__: "err",
        err: value.err
    } : value;
